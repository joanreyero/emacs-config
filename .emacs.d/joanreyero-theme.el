...
;;; joanreyero-theme.el --- Custom theme for faces
...
(deftheme joanreyero
  "Face colors similar to markers on a joanreyero.")
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((,class (:background "goldenrod3"))))
   ...
   `(outline-5 ((,class (:foreground "turquoise4"))))
   ...
   `(org-agenda-date ((,class (:foreground "SteelBlue" :height 1.1
                                           :box (:line-width 7 :color "whitesmoke")
                                           :weight bold))))
   `(org-agenda-date-today ((,class (:inherit org-agenda-date
                                              :foreground "Blue3"))))
   `(org-scheduled ((,class (:foreground "turquoise4"))))
   `(org-scheduled-today ((,class (:inherit org-scheduled
                                            :foreground "turquoise4"))))

   `(org-upcoming-deadline ((,class (:foreground "Red4"))))
   `(org-warning ((,class (:foreground "Red3"))))
   `(org-time-grid ((,class (:foreground "grey70"))))
   `(org-agenda-current-time ((,class (:foreground "grey50"))))
   `(org-agenda-calendar-event ((,class (:foreground "#41416b"))))
;   `(org-agenda-dimmed-todo-face ((,class (:foreground "SteelBlue"))))
   `(org-agenda-dimmed-todo-face ((,class (:foreground "SteelBlue"
                                           :weight bold))))
   `(org-priority ((,class (:foreground "gray60"))))
   ))

(provide-theme 'joanreyero)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; joanreyero-theme.el ends here
