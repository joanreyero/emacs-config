...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(cursor                         ((,class (:inverse-video t :background "goldenrod3"))))
   ...
   `(org-level-1                    ((,class (:foreground "Blue3"
					      :weight bold))))
   `(org-level-2                    ((,class (:foreground "DodgerBlue"))))
   `(org-level-3                    ((,class (:foreground "SteelBlue"))))
   `(org-level-4                    ((,class (:foreground "RoyalBlue"))))
   `(org-level-5                    ((,class (:foreground "DeepSkyBlue"))))
